...
/********************   ClsDef    ********************/
ClsDef::ClsDef(Ident p1, ListClsElems *p2)
{
  ident_ = p1;
  listclselems_ = p2;
...
{
  ident_ = other.ident_;
  listclselems_ = other.listclselems_->clone();
...
{
  std::swap(ident_, other.ident_);
  std::swap(listclselems_, other.listclselems_);

}

ClsDef::~ClsDef()
{
  delete(listclselems_);
...
/********************   ExtClsDef    ********************/
ExtClsDef::ExtClsDef(Ident p1, Ident p2, ListClsElems *p3)
{
  ident_1 = p1;
  ident_2 = p2;
  listclselems_ = p3;
...
ExtClsDef::ExtClsDef(const ExtClsDef & other)
{
...
ExtClsDef &ExtClsDef::operator=(const ExtClsDef & other)
{
  ExtClsDef tmp(other);
  swap(tmp);
  return *this;
...
void ExtClsDef::swap(ExtClsDef & other)
{
...
void ExtClsDef::accept(Visitor *v)
{
  v->visitExtClsDef(this);
}

ExtClsDef *ExtClsDef::clone() const
{
  return new ExtClsDef(*this);
}
...
/********************   ClsMethod    ********************/
ClsMethod::ClsMethod(Type *p1, Ident p2, ListArg *p3, Block *p4)
{
  type_ = p1;
  ident_ = p2;
  listarg_ = p3;
...
ClsMethod::ClsMethod(const ClsMethod & other)
{
  type_ = other.type_->clone();
  ident_ = other.ident_;
  listarg_ = other.listarg_->clone();
...
ClsMethod &ClsMethod::operator=(const ClsMethod & other)
{
  ClsMethod tmp(other);
  swap(tmp);
  return *this;
...
void ClsMethod::swap(ClsMethod & other)
{
  std::swap(type_, other.type_);
  std::swap(ident_, other.ident_);
  std::swap(listarg_, other.listarg_);
...
void ClsMethod::accept(Visitor *v)
{
  v->visitClsMethod(this);
}

ClsMethod *ClsMethod::clone() const
{
...
/********************   ClsField    ********************/
ClsField::ClsField(Type *p1, Ident p2)
{
  type_ = p1;
  ident_ = p2;
...
ClsField::ClsField(const ClsField & other)
{
  type_ = other.type_->clone();
  ident_ = other.ident_;
...
ClsField &ClsField::operator=(const ClsField & other)
{
  ClsField tmp(other);
  swap(tmp);
  return *this;
...
void ClsField::swap(ClsField & other)
{
  std::swap(type_, other.type_);
  std::swap(ident_, other.ident_);
...
void ClsField::accept(Visitor *v)
{
  v->visitClsField(this);
}

ClsField *ClsField::clone() const
{
  return new ClsField(*this);
}
...
/********************   For    ********************/
For::For(Type *p1, Ident p2, Ident p3, Stmt *p4)
{
  type_ = p1;
  ident_1 = p2;
  ident_2 = p3;
...
/********************   BType    ********************/
BType::BType(BasicType *p1)
{
  basictype_ = p1;

}

BType::BType(const BType & other)
{
  basictype_ = other.basictype_->clone();

}

BType &BType::operator=(const BType & other)
{
  BType tmp(other);
  swap(tmp);
  return *this;
...
/********************   ArrayType    ********************/
ArrayType::ArrayType(TypeName *p1)
{
  typename_ = p1;
...
/********************   NormalType    ********************/
NormalType::NormalType(TypeName *p1)
{
  typename_ = p1;

}

NormalType::NormalType(const NormalType & other)
{
  typename_ = other.typename_->clone();

}

NormalType &NormalType::operator=(const NormalType & other)
{
  NormalType tmp(other);
  swap(tmp);
  return *this;
}

void NormalType::swap(NormalType & other)
{
  std::swap(typename_, other.typename_);
...
void NormalType::accept(Visitor *v)
{
  v->visitNormalType(this);
}

NormalType *NormalType::clone() const
{
...
/********************   EMetCall    ********************/
EMetCall::EMetCall(Expr *p1, Ident p2, ListExpr *p3)
{
  expr_ = p1;
  ident_ = p2;
  listexpr_ = p3;
...
EMetCall::EMetCall(const EMetCall & other)
{
  expr_ = other.expr_->clone();
  ident_ = other.ident_;
...
EMetCall &EMetCall::operator=(const EMetCall & other)
{
  EMetCall tmp(other);
  swap(tmp);
  return *this;
...
void EMetCall::swap(EMetCall & other)
{
  std::swap(expr_, other.expr_);
  std::swap(ident_, other.ident_);
...
void EMetCall::accept(Visitor *v)
{
  v->visitEMetCall(this);
}

EMetCall *EMetCall::clone() const
{
  return new EMetCall(*this);
}
...
ECastNull &ECastNull::operator=(const ECastNull & other)
{
  ECastNull tmp(other);
  swap(tmp);
  return *this;
...
void ECastNull::accept(Visitor *v)
{
  v->visitECastNull(this);
}

ECastNull *ECastNull::clone() const
{
  return new ECastNull(*this);
}



/********************   EAt    ********************/
EAt::EAt(Expr *p1, Expr *p2)
{
  expr_1 = p1;
  expr_2 = p2;
...
/********************   ENewCls    ********************/
ENewCls::ENewCls(Ident p1)
{
  ident_ = p1;

}

ENewCls::ENewCls(const ENewCls & other)
{
  ident_ = other.ident_;

}

ENewCls &ENewCls::operator=(const ENewCls & other)
{
  ENewCls tmp(other);
  swap(tmp);
  return *this;
...
void ENewCls::swap(ENewCls & other)
{
  std::swap(ident_, other.ident_);
...
void ENewCls::accept(Visitor *v)
{
  v->visitENewCls(this);
}

ENewCls *ENewCls::clone() const
{
  return new ENewCls(*this);
}
...
void ListClsElems::accept(Visitor *v)
{
  v->visitListClsElems(this);
}


ListClsElems *ListClsElems::clone() const
{
  return new ListClsElems(*this);
}
